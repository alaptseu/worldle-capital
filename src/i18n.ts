...
export const translations = {
  en: {
    translation: {
      ...
      install: {
        title: "Worldle Capital",
        descritpionTitle: "App Install:",
        description: "Add Worldle Capital to Home Screen to play it easily!",
  ...
  fr: {
    translation: {
      ...
      install: {
        ...
        description:
          "Ajouter Worldle Capital sur l'écran d'accueil pour le retrouver plus facilement !",
        instructionTitle: "Instructions :",
        instructionActionOk: "OK",
  ...
  hu: {
    translation: {
      ...
      install: {
        ...
        description:
          "Add hozzá a Worldle Capital a Kezdőképernyőhöz, hogy egyszerűbben játszhass!",
        instructionTitle: "In",
        instructionActionOk: "OK",
  ...
  nl: {
    translation: {
      ...
      install: {
        ...
        description:
          "Voeg Worldle Capital toe aan je beginscherm om het makkelijk te spelen!",
  ...
  pl: {
    translation: {
      ...
      install: {
        ...
        description:
          "Dodaj Worldle Capital do ekranu głównego żeby grać łatwiej!",
  ...
  br: {
    translation: {
      ...
      install: {
        ...
        description:
          "Adicione Worldle Capital a sua página inicial para jogar mais facilmente!",

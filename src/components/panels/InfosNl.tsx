  ...
  return (
    <Panel title="Spelinstructies" isOpen={isOpen} close={close}>
      <div className="space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3">
        <div>
          Je hebt 6 kansen om de <WorldleCapital /> te raden.
        </div>
      ...
      <div className="space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3 font-bold">
        Er is iedere dag een nieuwe <WorldleCapital /> beschikbaar!
      </div>
      <div className="space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3">
      ...
      <div className="space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3">
        <WorldleCapital /> is <span className="font-bold">sterk</span>{" "}
        geïnspireerd door{" "}
        <a
          className="underline"

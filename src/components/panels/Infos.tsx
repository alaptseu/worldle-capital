...
import { WorldleCapital } from "../WorldleCapital";
  ...
  return (
    <Panel title="How to play" isOpen={isOpen} close={close}>
      <div className="space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3">
        <div>
          Guess the <WorldleCapital /> in 6 guesses.
        </div>
        <div>
          Each guess must be a valid capital of the country, territory...
        </div>
        <div>
      ...
      <div className="space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3 font-bold">
        A new <WorldleCapital /> will be available every day!
      </div>
      <div className="space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3">
      ...
      <div className="space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3">
        <WorldleCapital /> has been <span className="font-bold">heavily</span>{" "}
        inspired by{" "}
        <a
          className="underline"
      ...
      <div className="space-y-3 text-justify pb-3">
        <div>
          ...
          <a
            className="underline"
            href="https://github.com/alaptseu"
            target="_blank"
            rel="noopener noreferrer"
          >
            @teuteuf
          ...
          <a
            className="underline"
            href="https://github.com/alaptseu/worldle-capital/"
            target="_blank"
            rel="noopener noreferrer"
          >
            source code

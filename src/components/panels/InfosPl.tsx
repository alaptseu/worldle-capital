  ...
  return (
    <Panel title="Zasady gry" isOpen={isOpen} close={close}>
      <div className="space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3">
        <div>
          Odgadnij <WorldleCapital /> w 6. próbach.
        </div>
        <div>
      ...
      <div className="space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3 font-bold">
        Nowe <WorldleCapital /> będzie pojawiać się każdego dnia!
      </div>
      <div className="space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3">
      ...
      <div className="space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3">
        <WorldleCapital /> wzoruje się w{" "}
        <span className="font-bold">dużej</span> mierze na{" "}
        <a
          className="underline"
